...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection surgery_time
     ...
     * @method Grid\Column|Collection surgery_time(string $label = null)
     ...
     * @property Show\Field|Collection surgery_time
     ...
     * @method Show\Field|Collection surgery_time(string $label = null)
